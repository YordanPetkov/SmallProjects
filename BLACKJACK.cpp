...
void visualgame(int brccards,int brmycards,int csum11,int csum,int mysum11,int mysum,int cmoney,int mymoney,int pot,string nickname)
{
    ...
    color(41);
    cout<<" =============================================================================="<<endl;
    cout<<"                         Shadow Black Jack <SBJ> v1.1 2016"<<endl;
    cout<<" =============================================================================="<<endl;
    cout<<"                                  Have Fun !"<<endl;
color(41);cout<<"   ";
...
void startgamecard ()
{
    ...
    visualgame(1,0,0,0,0,0,cmoney,mymoney,0,nickname);
}
...
void game()
{
    ...
    cardcheckwrite :
       ...
       if(sum==sum11) visualgame(1,brmycards,0,0,0,sum,cmoney,mymoney,pot,nickname);
       else if(sum>21 || sum>sum11){visualgame(1,brmycards,0,0,0,sum11,cmoney,mymoney,pot,nickname);}
             else if(sum11>21){visualgame(1,brmycards,0,0,0,sum,cmoney,mymoney,pot,nickname);}
                   else {visualgame(1,brmycards,0,0,sum11,sum,cmoney,mymoney,pot,nickname);}
...
int gameon()
{
    betpot:
    system("CLS");
    cout<<"                          SHADOW BLACKJACK v 1.1"<<endl; cout<<endl; cout<<endl;
    ...
    cout<<endl;
    if((gsum>gcsum || gcsum>21) && gsum<22){cout<<endl;cout<<"                           YOU WON"<<endl;cout<<"Press any key to continue "<<endl;cout<<endl;getch();return 1;}
    if((gsum<gcsum || gsum>21)&& gcsum<22){cout<<endl;cout<<"                           YOU LOSE"<<endl;cout<<"Press any key to continue "<<endl;cout<<endl;getch();return 2;}
    if(gsum==gcsum ){cout<<endl;cout<<"                           DRAW"<<endl;cout<<"Press any key to continue "<<endl;cout<<endl;getch();return 3;}
}
int main()
{
    string ans;
    ...
    cout<<"                          SHADOW BLACKJACK v 1.1"<<endl;
